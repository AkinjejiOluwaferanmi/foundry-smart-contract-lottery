...
contract Raffle is VRFConsumerBaseV2Plus {
     ...
     * The following shold should be true in order for upkeepNeeded to be true:
    ...
    function fulfillRandomWords(uint256, /* requestId */ uint256[] calldata randomWords) internal override {
        uint256 indexOfWnner = randomWords[0] % s_players.length;
        address payable recentWinner = s_players[indexOfWnner];
